...
/** 
 * DAO for table "STAR_COMIC".
*/
public class StarComicDao extends AbstractDao<StarComic, Long> {

    public static final String TABLENAME = "STAR_COMIC";

    /**
     * Properties of entity StarComic.<br/>
    ...
    */
    ...
    public StarComicDao(DaoConfig config) {
        super(config);
    }
    
    public StarComicDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STAR_COMIC\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"STAR_COMIC\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, StarComic entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public StarComic readEntity(Cursor cursor, int offset) {
        StarComic entity = new StarComic( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, StarComic entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(StarComic entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(StarComic entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
