...
public class RxEvent {
    ...
    public static final int EVENT_TAG_UPDATE = 82;
    public static final int EVENT_TAG_RESTORE = 83;
    ...
    @IntDef({EVENT_COMIC_FAVORITE, EVENT_COMIC_UNFAVORITE, EVENT_COMIC_READ, EVENT_COMIC_PAGE_CHANGE, EVENT_COMIC_CHAPTER_CHANGE,
            ...
            EVENT_DOWNLOAD_START, EVENT_DOWNLOAD_STOP, EVENT_SOURCE_ENABLE, EVENT_SOURCE_DISABLE, EVENT_TAG_DELETE,
            EVENT_THEME_CHANGE, EVENT_TAG_UPDATE, EVENT_TAG_RESTORE, EVENT_DIALOG_PROGRESS})
